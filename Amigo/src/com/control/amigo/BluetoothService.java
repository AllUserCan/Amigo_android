...
import com.control.amigo.BluetoothConnect.BTdevicestate;
...
public class BluetoothService extends Service {
	...
	private void stopConnect(){
		...
		BluetoothConnect.mBTdevicestate = BTdevicestate.opened;
	...
	public class ServiceThread implements Runnable {
		...
		public void run() {
			...
			try{
				...
				BluetoothConnect.mBTdevicestate = BTdevicestate.connected;
